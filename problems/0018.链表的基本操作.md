...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        //头插法
        for (int i = 0; i < n; i++) {
            c = new ListNode(in.nextInt(), dummy.next);  //c.next=dummy.next
            dummy.next = c;
        }
        int m = in.nextInt();
        in.nextLine();
        for (int i = 0; i < m; i++) {
            ...
            if (s.contains("show")) {
                ...
                int a = Integer.valueOf(s.split(" ")[1]);
                delete(dummy, a); //删除第a个元素，a从1开始
            } else if (s.contains("insert")) {
                int a = Integer.valueOf(s.split(" ")[1]);
                int e = Integer.valueOf(s.split(" ")[2]);
                insert(dummy, a, e);
    ...
    public static void show(ListNode dummy) {
        if (dummy.next == null) {
            System.out.println("Link list is empty");
            return;
        }
    ...
    public static void delete(ListNode dummy, int a) {
        ListNode t = dummy;
        for (int i = 0; i < a - 1; i++) { //移动a-1下到达前驱
            if (t == null) {
                System.out.println("delete fail");
                return;
            }
    ...
    public static void insert(ListNode dummy, int a, int e) {
        ListNode t = dummy;
        for (int i = 0; i < a - 1; i++) { //移动a-1下到达前驱
            if (t == null) {
                System.out.println("insert fail");
        ...
        if (t == null) {
            ...
            ListNode nodeE = new ListNode(e, t.next);
            t.next = nodeE;
            System.out.println("insert OK");
        }
    }

    public static void get(ListNode dummy, int a) {
        ListNode t = dummy;
        for (int i = 0; i < a; i++) { //移动a下到达本身
            if (t == null) {
                System.out.println("get fail");
                return;
            }
